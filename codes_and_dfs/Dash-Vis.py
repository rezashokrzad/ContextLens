...
def process_file(clicks, input_w, input_n):
    ...
    if not user_doc.empty and user_doc.shape[0] > 2000:
        return html.A("Number of sentences should not exceed 2000", id="log", style={'color': 'red', 'font-family': 'Comic Sans MS'})
